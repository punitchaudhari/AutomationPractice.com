...
public class Page_bestSales {

	public WebDriver driver;
	Logger log = LoggerHelper.getLogger(Page_bestSales.class);

	public Page_bestSales(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		log.info("Page_bestSales Class Object Created");
		TestBase.test.log(Status.INFO, "Page_bestSales Class Object Created");
	}
	...
	public WebElement lbl_bestSellers;
