...
public class Page_summerDresses {
	public WebDriver driver;
	Logger log = LoggerHelper.getLogger(Page_summerDresses.class);

	public Page_summerDresses(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		log.info("Page_summerDresses Class Object Created");
		TestBase.test.log(Status.INFO, "Page_summerDresses Class Object Created");
	}
