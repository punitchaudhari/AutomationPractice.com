...
public class Page_dresses {
	...
	public WebElement img_casualDresses;

	@FindBy(xpath = "//*[@id='subcategories']/ul/li[2]/div[1]/a")
	public WebElement img_eveningDresses;

	@FindBy(xpath = "//*[@id='subcategories']/ul/li[3]/div[1]/a")
	public WebElement img_summerDresses;
	...
	public Page_casualDresses clkCasualDressesImage() {
		img_casualDresses.click();
		log.info("Clicked on 'Casual Dresses' image  ");
		TestBase.test.log(Status.INFO, "Clicked on 'Casual Dresses' image  ");
		return new Page_casualDresses(driver);
	}

	public Page_eveningDresses clkEveningDressesImage() {
		img_eveningDresses.click();
		log.info("Clicked on 'Evening Dresses' image  ");
		TestBase.test.log(Status.INFO, "Clicked on 'Evening Dresses' image  ");
		return new Page_eveningDresses(driver);
	}

	public Page_summerDresses clkSummerDressesImage() {
		img_summerDresses.click();
		log.info("Clicked on 'Summer Dresses' image  ");
		TestBase.test.log(Status.INFO, "Clicked on 'Summer Dresses' image  ");
		return new Page_summerDresses(driver);
	}
