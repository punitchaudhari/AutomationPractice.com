...
public class Page_blouses {

	public WebDriver driver;
	Logger log = LoggerHelper.getLogger(Page_blouses.class);

	public Page_blouses(WebDriver driver) {
		this.driver = driver;

		PageFactory.initElements(driver, this);
		log.info("Page_blouses Class Object Created");
		TestBase.test.log(Status.INFO, "Page_blouses Class Object Created");
	}
