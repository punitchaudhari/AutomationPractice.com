...
public class Page_fashionManufacturer {
	public WebDriver driver;
	Logger log = LoggerHelper.getLogger(Page_fashionManufacturer.class);
	
	public Page_fashionManufacturer(WebDriver driver){
		this.driver = driver;
		PageFactory.initElements(driver, this);
		log.info("Page_fashionManufacturer Class Object Created");
		TestBase.test.log(Status.INFO,"Page_fashionManufacturer Class Object Created");	
	}
	...
	public WebElement lbl_fashionManufacturer;
	
	@FindBy(xpath = "//*[@id='center_column']/h1")
	public WebElement lbl_listOfProductsByManufacturer;
	...
	@FindBy(xpath = "//*[@id='center_column']/ul/li/div/div[2]/div[4]/ul/li")
	...
	public void select_sortBy(String optionToBeSelected){
		DropdownHelper ddh = new DropdownHelper(driver);
		ddh.selectByVisibleText(dd_sortBy, optionToBeSelected);
	}
	public void clkGrid() {
		btn_grid.click();
