...
public class Page_women {
	...
	public Page_dresses clkdresses() {
		link_dresses.click();
		log.info("Clicked on 'dresses' link  ");
		TestBase.test.log(Status.INFO, "Clicked on 'dresses' link  ");
		return new Page_dresses(driver);
	}
	...
	public void clkPlusButton1() {
		btn_plusButton1.click();
		log.info("Clicked on 'plus button 1'");
		TestBase.test.log(Status.INFO, "Clicked on 'plus button 1'");
	}

	public void clkPlusButton2() {
		btn_plusButton2.click();
		log.info("Clicked on 'plus button 2'");
		TestBase.test.log(Status.INFO, "Clicked on 'plus button 2'");
	}

	public Page_tops clkTopsImage() {
		img_tops.click();
		log.info("Clicked on 'Tops' image  ");
		TestBase.test.log(Status.INFO, "Clicked on 'Tops' image  ");
		return new Page_tops(driver);
	}

	public Page_dresses clkDressesImage() {
		img_dresses.click();
		log.info("Clicked on 'Dresses' image  ");
		TestBase.test.log(Status.INFO, "Clicked on 'Dresses' image  ");
		return new Page_dresses(driver);
	}
