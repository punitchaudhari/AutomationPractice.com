...
public class Page_fashionSupplier {
	public WebDriver driver;
	Logger log = LoggerHelper.getLogger(Page_fashionSupplier.class);

	public Page_fashionSupplier(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
		log.info("Page_fashionSupplier Class Object Created");
		TestBase.test.log(Status.INFO, "Page_fashionSupplier Class Object Created");
	}
	@FindBy(xpath = "//*[@id='columns']/div[1]/a")
	public WebElement img_homeIcon;
	
	@FindBy(xpath = "//*[@id='columns']/div[1]/span[2]")
	public WebElement lbl_fashionSupplier;
	
	@FindBy(xpath = "//*[@id='center_column']/h1")
	public WebElement lbl_listOfProductsBySupplier;
	...
	@FindBy(xpath = "//*[@id='center_column']/ul/li/div/div[2]/div[3]/ul/li/a")
